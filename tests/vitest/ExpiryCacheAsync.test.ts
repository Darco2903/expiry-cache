...
describe("ExpiryCacheAsync update expiration time", () => {
    it("setExpiresIn updates expiration time correctly", () => {
        const cache = new ExpiryCacheAsync(10, async () => 0, 100);
...
describe("ExpiryCacheAsync with return options", () => {
    ...
    it("should handle expires at return options correctly", async () => {
        const cache = new ExpiryCacheAsync(
            10,
            async () => {
...
describe("ExpiryCacheAsync expire event", () => {
    it("should emit expire event when cache expires", async () => {
        const cache = new ExpiryCacheAsync(10, async () => 0, 50);
...
describe("ExpiryCacheAsync refreshed event", () => {
    it("should emit refreshed event when cache is refreshed", async () => {
        const cache = new ExpiryCacheAsync(10, async () => 0, 1000);
